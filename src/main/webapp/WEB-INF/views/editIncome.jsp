...
<element id="c5226e17-3b72-44a9-bca5-c098608be8b7" data-section-id="c5226e17-3b72-44a9-bca5-c098608be8b7">
    ...
    <htmlCode>
        <div id="root" class="min-h-screen bg-neutral-900">
            <div x-data="{ isOpen: true, showAddIncome: true }" class="min-h-screen">
                <!-- Main Content -->
                <div class="lg:pl-64">
						    ...
						    <div class="flex items-center justify-center min-h-screen px-4">
						        ...
						        <div class="relative bg-neutral-800 rounded-lg max-w-lg w-full p-6">
						            <div class="flex justify-between items-center mb-4">
						                <h3 class="text-xl font-bold text-white">Update Income</h3>
						            </div>
						            <form action="updateincome" method="post" class="space-y-4" id="income-form">
						                    ...
						                    <div>
						                        ...
						                        <select name="account_no"
						                            ...
						                            <c:forEach items="${accounts}" var="a" varStatus="status">
						                                <option value="${a.id}"
						                                	<c:if test="${a.id == income.account.id}">selected</c:if>>
						                                	${a.title}
						                                </option>
						                            </c:forEach>
						                        </select>
						                ...
						                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
						                    <div>
						                        ...
						                        <input type="date" name="transcationData" value="${income.transcationData}"
						                            class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:outline-none focus:border-green-500">
						                    </div>
						                    <div>
						                        ...
						                        <textarea name="description"
						                            ...
						                            rows="3">${income.description}</textarea>
						                    </div>
						                </div>
