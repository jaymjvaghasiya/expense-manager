...
<element id="c5226e17-3b72-44a9-bca5-c098608be8b7" data-section-id="c5226e17-3b72-44a9-bca5-c098608be8b7">

    <htmlCode>
        <div id="root" class="min-h-screen bg-neutral-900">
            <div x-data="{ isOpen: false, showAddIncome: false }" class="min-h-screen">
                <!-- Main Content -->
                <div class="lg:pl-64">
                    <section id="income_management" class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h1 class="text-2xl font-bold text-white">Income Management</h1>
                            <button @click="showAddIncome = true"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            <div class="bg-neutral-800 rounded-lg border border-neutral-700/30 p-6">
                                <h3 class="text-neutral-400 mb-2">Total Income This Month</h3>
                                <p class="text-2xl font-bold text-green-500">$8,750.00</p>
                            </div>
                            <div class="bg-neutral-800 rounded-lg border border-neutral-700/30 p-6">
                                <h3 class="text-neutral-400 mb-2">Main Income Source</h3>
                                <p class="text-2xl font-bold text-blue-500">Salary</p>
                            </div>
                            <div class="bg-neutral-800 rounded-lg border border-neutral-700/30 p-6">
                                <h3 class="text-neutral-400 mb-2">Average Monthly Income</h3>
                                <p class="text-2xl font-bold text-purple-500">$7,500.00</p>
                            </div>
                        </div>
                        ...
                        <div class="bg-neutral-800 rounded-lg border border-neutral-700/30 overflow-hidden">
                            <div class="p-4">
                                <div class="flex justify-between items-center mb-4">
                                    <h2 class="text-lg font-semibold text-white">Income History</h2>
                                    <div class="flex space-x-2">
                                        <input type="text" placeholder="Search income..."
                                            class="px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:outline-none focus:border-green-500">
                                        <select
                                            class="px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:outline-none focus:border-green-500">
                                ...
                                <div class="overflow-x-auto">
                                    <table class="w-full text-left">
                                        ...
                                        <tbody class="text-neutral-300">
                                        	<c:forEach items="${incomes}" var="i" varStatus="status">
	                                            <tr class="border-b border-neutral-700/30">
	                                                <td class="px-6 py-4">${i.transcationData}</td>
	                                                <td class="px-6 py-4 ${i.status == 'Received' ? 'text-green-500' : 'text-yellow-500'} ">${i.amount}</td>
	                                                <td class="px-6 py-4">${i.account.title}</td>
	                                                <td class="px-6 py-4">
	                                                    <span
	                                                        class="px-2 py-1 text-xs rounded-full ${i.status == 'Received' ? 'bg-green-500/10 text-green-500' : 'bg-yellow-500/10 text-yellow-500'} ">${i.status}</span>
	                                                </td>
	                                                <td class="px-6 py-4">
	                                                    <div class="flex space-x-2">
	                                                    	<a href="editincome?incomeId=${i.incomeId}">
                        ...
                        <!-- Add Income Modal -->
                    	<div x-show="showAddIncome" class="fixed inset-0 z-50 overflow-y-auto" x-cloak>
						    <div class="flex items-center justify-center min-h-screen px-4">
						        <div class="fixed inset-0 bg-black opacity-50"></div>
						        <div class="relative bg-neutral-800 rounded-lg max-w-lg w-full p-6">
						            <div class="flex justify-between items-center mb-4">
						                <h3 class="text-xl font-bold text-white">Add New Income</h3>
						                <button @click="showAddIncome = false" class="text-neutral-400 hover:text-white">
						                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
						                    </svg>
						                </button>
						            </div>
						            <form action="addnewincome" method="post" class="space-y-4" id="income-form">
						                <!-- Income Source and Amount -->
						                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
						                    <div>
						                        <label class="block text-sm font-medium text-neutral-300 mb-1">Income Source</label>
						                ...
						                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
						                    <div>
						                        ...
						                        <input type="date" name="transcationData"
						                            class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:outline-none focus:border-green-500">
						                    </div>
						                    <div>
						                ...
						                <div class="flex justify-end space-x-3">
						                    <button type="button" @click="showAddIncome = false" class="px-4 py-2 text-neutral-400 hover:text-white">
						                        Cancel
						                    </button>
