...
<div id="root" class="min-h-screen bg-neutral-900">
	<div x-data="{ isOpen: false, showAddModal: true }"
		class="min-h-screen">
					...
					<div class="flex items-center justify-center min-h-screen px-4">
						...
						<div
							...
							<div class="flex justify-between items-center mb-4">
								<h3 class="text-xl font-bold text-white">Update Account</h3>
							</div>
							<form class="space-y-4" action="updateaccount" method="post">
								<input type="hidden" name="id" value="${account.id}">
								<div>
									<label class="block text-sm font-medium text-neutral-300 mb-1">Account
										Name</label> <input type="text" name="title" value="${account.title}"
								...
								<div>
									<label class="block text-sm font-medium text-neutral-300 mb-1">Account
										Type</label> <select name="account_type" value="${account.account_type}"
										class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:outline-none focus:border-blue-500">
										...
										<option value="Debit Card" ${account.account_type == 'Debit Card' ? 'selected' : ''}>Debit Card</option>
								...
								<div>
									<label class="block text-sm font-medium text-neutral-300 mb-1">Initial
										Balance</label> <input type="number" name="amount" value="${account.amount}"
										class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:outline-none focus:border-blue-500">
								</div>
								<%-- <div>
									<label class="block text-sm font-medium text-neutral-300 mb-1">Description
										</label> <input type="text" name="description" value="${account.description}"
										class="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-white focus:outline-none focus:border-blue-500">
								</div> --%>
								<div>
                                    <label
								...
								<div class="flex justify-end space-x-3">
									<button type="button" @click="showAddModal = false"
										...
										<a href="listaccounts">Cancel</a></button>
									<button type="submit"
